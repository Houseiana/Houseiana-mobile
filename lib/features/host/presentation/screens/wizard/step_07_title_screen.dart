...
class _Step07TitleScreenState extends State<Step07TitleScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayHighlights =
        _isLoadingHighlights ? _mockHighlights : _highlightsLookup;
          ...
          Skeletonizer(
            ...
            child: Wrap(
              ...
              children: displayHighlights.map((h) {
                ...
                final isSelected =
                    !_isLoadingHighlights && selectedHighlights.contains(id);
                ...
                return ChoiceChip(
                  label: Text(
                    ...
                    style: TextStyle(
                      color:
                          isSelected ? AppColors.charcoal : AppColors.charcoal,
                      fontWeight:
                  ...
                  onSelected: _isLoadingHighlights
                      ...
                      : (v) {
                          ...
                          cubit
                              .updateStepData({'highlights': updated.toList()});
                        },
