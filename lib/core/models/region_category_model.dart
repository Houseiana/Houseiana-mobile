...
/// [name] is localized by the backend per the `lang` request header. The chosen
/// [id] is sent to `/api/property-search` as the `villageId` query param to
/// filter the home listings to that region.
